...
if (isset($_POST['username']))
{
    ...
    else
    {
        if (mysql_num_rows(queryMysql("SELECT * FROM applicant
		  ...
		  {
            queryMysql("INSERT INTO applicant (username, password, email) VALUES('$user', '$pass', '$email')");
...
echo <<<_END
     ...
     <div id='logsign' align='center'>
          ...
          <form method='post' action='appsignup.php' autocomplete='off' autofocus>$error
          <div class="row">
               Username:
               <span class="form">
...
<fieldset>
<a style='color:#FF6600;' href='applogin.php'>Login Here</a></li>
</fieldset>
</div>
