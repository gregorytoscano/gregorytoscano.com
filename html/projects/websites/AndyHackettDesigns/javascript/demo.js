    ...
    $("a.polaroid").each(function() {
        $(this)
            .css({
                ...
                "-ms-transform": 'rotate(' +(Math.floor(Math.random()*10)-5) + 'deg)'
            })
            .hover(function() {
                $(this).css({
                    ...
                    "-ms-transform": 'rotate(' + (Math.floor(Math.random()*10)-5) + 'deg) scale(1.05)'
                })
            }, function() {
                $(this).css({
                    ...
                    "-ms-transform": 'rotate(' + (Math.floor(Math.random()*10)-5) + 'deg) scale(1)'
                })
            });
    });
